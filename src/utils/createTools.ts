export const createTools = (service: "openai" | "anthropic") => {
  ...
  const readFilesDefinition = (service: "openai" | "anthropic") => {
    const defenition = {
      name: "readFiles",
      description:
  ...
  const updateFilesDefinition = (service: "openai" | "anthropic") => {
    const defenition = {
      name: "updateFiles",
      description:
  ...
  return [
    readFilesDefinition(service),
    updateFilesDefinition(service),
