...
export const defineUpdateProjectState = (updateProjectState: (params: IUpdateProjectStateParams) => Promise<void>) => tool({
  description:
        ...
        tasks: z
          .array(
            z.object({
              ...
              status: z
                .enum(["todo", "in_progress", "completed", "hold", "no_need"])
  ...
  execute: async ({ ProjectStateUpdates }) => await updateProjectState({
    ProjectStateUpdates: {
      ...ProjectStateUpdates,
