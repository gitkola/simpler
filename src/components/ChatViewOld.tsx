...
export const ChatViewOld: React.FC = () => {
  const {
  ...
  const handleContextChange =
    (action: any) => (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="flex flex-col border-r border-0.5 min-w-[900px] max-w-[1200px]">
      ...
      <div className="flex-1 flex flex-col justify-between overflow-hidden">
        ...
        <div
          id="input_section"
          className="flex-wrap p-2 border-t border-0.5 overflow-y-hidden"
        >
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col">
              ...
              {currentProjectSettingsError && (
                <div>{currentProjectSettingsError}</div>
              )}
              {!isLoadingCurrentProjectSettings &&
                currentProjectSettings?.service && (
