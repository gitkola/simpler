...
export default function EditorView() {
  ...
  return (
    <div className="flex flex-col h-screen border-r border-0.5 overflow-x-scroll">
      <div className="flex p-2 space-x-8 items-center justify-start border-b border-0.5">
