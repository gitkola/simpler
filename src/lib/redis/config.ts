...
export const redisConfig: RedisConfig = {
  useLocalRedis: import.meta.env.VITE_USE_LOCAL_REDIS === "true",
  upstashRedisRestUrl: import.meta.env.VITE_UPSTASH_REDIS_REST_URL,
  upstashRedisRestToken: import.meta.env.VITE_UPSTASH_REDIS_REST_TOKEN,
  localRedisUrl:
    import.meta.env.VITE_LOCAL_REDIS_URL || "redis://localhost:6379",
};
